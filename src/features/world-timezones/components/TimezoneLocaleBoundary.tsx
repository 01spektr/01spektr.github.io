...
const EN_EXTRA: Record<string, string> = {
  ...
  "Добавить в планировщик встречи": "Add to meeting planner", "Географическая панорама поясов UTC, меридианов и городов мира": "Geographic view of UTC zones, meridians and world cities",
  "Пояса UTC": "UTC zones", "Показать или скрыть границы поясов": "Show or hide time zone boundaries", "Стиль карты": "Map style",
  "Светлая (Минимализм)": "Light (minimal)", "Топографическая": "Topographic", "Приблизить карту": "Zoom in", "Отдалить карту": "Zoom out",
  "Сбросить масштаб (Весь мир)": "Reset view (whole world)", "На встрече / в фокусе": "Meeting / in focus", "Города мира": "World cities",
  "Кликните на любой город для действий": "Click any city for actions", "Текущее время:": "Current time:", "Часовой пояс:": "Time zone:", "+ Встреча": "+ Meeting",
  "(ИЗ)": "(FROM)", "(Из)": "(FROM)", "(В)": "(TO)", "Пресеты:": "PRESETS:", "Выберите город для добавления:": "Select a city to add:", "Отмена": "Cancel",
  "Поиск города...": "Search city...", "Поиск города, страны...": "Search city or country...", "Города не найдены": "No cities found",
  "Попробуйте изменить поисковый запрос или сбросить фильтры": "Try changing the search or resetting filters", "Все города уже добавлены": "All cities have already been added",
  "Скопировано!": "Copied!", "Скопировано в буфер!": "Copied to clipboard!", "Завтра": "Tomorrow", "Вчера": "Yesterday", "день": "day",
  "Город": "City", "Страна и континент": "Country and continent", "Часовой пояс (IANA)": "Time zone (IANA)", "Смещение UTC": "UTC offset", "Действия": "Actions",
  " отстает от ": " is behind ", " опережает ": " is ahead of ", " на ": " by ", " часа": " hours", " часов": " hours", " час": " hour",
  "Города находятся в одном часовом поясе": "The cities are in the same time zone", "Часовой пояс UTC": "UTC time zone", "Четкая": "detailed",
  "24-часовая шкала времени": "24-hour time scale", "ч": "h",
  "пн": "Mon", "вт": "Tue", "ср": "Wed", "чт": "Thu", "пт": "Fri", "сб": "Sat", "вс": "Sun", "сент.": "Sep",
};
const UZ_EXTRA: Record<string, string> = {
  ...
  "Добавить в планировщик встречи": "Uchrashuv rejasiga qo‘shish", "Географическая панорама поясов UTC, меридианов и городов мира": "UTC mintaqalari, meridianlar va dunyo shaharlarining geografik ko‘rinishi",
  "Пояса UTC": "UTC mintaqalari", "Показать или скрыть границы поясов": "Vaqt mintaqalari chegaralarini ko‘rsatish yoki yashirish", "Стиль карты": "Xarita uslubi",
  "Светлая (Минимализм)": "Yorug‘ (minimal)", "Топографическая": "Topografik", "Приблизить карту": "Xaritani yaqinlashtirish", "Отдалить карту": "Xaritani uzoqlashtirish",
  "Сбросить масштаб (Весь мир)": "Ko‘rinishni tiklash (butun dunyo)", "На встрече / в фокусе": "Uchrashuv / diqqat markazida", "Города мира": "Dunyo shaharlari",
  "Кликните на любой город для действий": "Amallar uchun istalgan shaharni bosing", "Текущее время:": "Joriy vaqt:", "Часовой пояс:": "Vaqt mintaqasi:", "+ Встреча": "+ Uchrashuv",
  "(ИЗ)": "(DAN)", "(Из)": "(DAN)", "(В)": "(GA)", "Пресеты:": "TAYYOR VAQTLAR:", "Выберите город для добавления:": "Qo‘shish uchun shaharni tanlang:", "Отмена": "Bekor qilish",
  "Поиск города...": "Shaharni qidiring...", "Поиск города, страны...": "Shahar yoki mamlakatni qidiring...", "Города не найдены": "Shaharlar topilmadi",
  "Попробуйте изменить поисковый запрос или сбросить фильтры": "Qidiruvni o‘zgartiring yoki filtrlarni tiklang", "Все города уже добавлены": "Barcha shaharlar allaqachon qo‘shilgan",
  "Скопировано!": "Nusxalandi!", "Скопировано в буфер!": "Buferga nusxalandi!", "Завтра": "Ertaga", "Вчера": "Kecha", "день": "kun",
  "Город": "Shahar", "Страна и континент": "Mamlakat va qit’a", "Часовой пояс (IANA)": "Vaqt mintaqasi (IANA)", "Смещение UTC": "UTC farqi", "Действия": "Amallar",
  " отстает от ": " dan ", " опережает ": " dan oldinda ", " на ": " ", " часа": " soat", " часов": " soat", " час": " soat",
  "Города находятся в одном часовом поясе": "Shaharlar bir xil vaqt mintaqasida", "Часовой пояс UTC": "UTC vaqt mintaqasi", "Четкая": "aniq",
  "24-часовая шкала времени": "24 soatlik vaqt shkalasi", "ч": "s",
  "пн": "Du", "вт": "Se", "ср": "Ch", "чт": "Pa", "пт": "Ju", "сб": "Sh", "вс": "Ya", "сент.": "sen.",
};
